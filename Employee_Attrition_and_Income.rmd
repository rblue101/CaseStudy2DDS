...
head(initial_salary)
View(initial_salary) # Looks like we have 870 observations with 36 total columns
skim(initial_salary) # Looking through the n_missing, we show that we don't have any missing values!
